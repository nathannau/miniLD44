...
:: Android packaging
set AND_CERT_NAME="StarlingTest01"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingTest01.p12
...
set IOS_PROVISION=cert\StarlingTest01.mobileprovision
...
set APP_ID=air.StarlingTest01

:: Output packages
set DIST_PATH=dist
set DIST_NAME=StarlingTest01
