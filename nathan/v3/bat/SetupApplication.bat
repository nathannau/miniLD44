...
:: Android packaging
set AND_CERT_NAME="miniLD44"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\miniLD44.p12
...
set IOS_PROVISION=cert\miniLD44.mobileprovision
...
set APP_ID=air.miniLD44

:: Output packages
set DIST_PATH=dist
set DIST_NAME=miniLD44
